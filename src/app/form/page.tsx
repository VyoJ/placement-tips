...
export default function PlacementInterviewForm() {
  ...
  return (
    <Card className="w-full max-w-2xl mx-auto">
      <CardHeader>
        <CardTitle className="text-2xl font-bold text-center">Placement Interview Form</CardTitle>
        <CardDescription className="text-center">Share your interview experience to help future candidates</CardDescription>
      </CardHeader>
      <CardContent>
        <div className="mb-6">
          <div className="flex justify-between items-center">
            {steps.map((s, index) => (
              <div key={index} className="flex flex-col items-center">
                <div className={`rounded-full p-2 ${step >= index ? 'bg-primary text-primary-foreground' : 'bg-muted'}`}>
                  {s.icon}
                </div>
